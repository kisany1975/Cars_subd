...
public:
	...
	* @return добавление каждый элемент в новый список
	*/
	List(const List<T>& ll);
	/*
	* @brief Перемещающий конструктор
	* @return перемещает данные из другого списка ll
	*/
	List(List<T>&& ll);
	/*
	* @brief Деструтктор
	...
	* @return проверяет, не происходит ли самоприсваивание и забирает данные из временной копии
	*/
